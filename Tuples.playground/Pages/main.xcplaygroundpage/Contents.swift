 ...
 */
print("Happy \(person.age+1) birthday, \(person.name)!")
 ...
 */
var oneYearOlder = someone.age + 1
print(oneYearOlder)
 ...
 */
//print("Happy \(oneYearOlder) birthday, \(someone.name)!")
 ...
 */
// no you can't as it is under a constant. It would be possible though if we change it to a variable.
